...
import com.basketball.play.adapter.base.BaseListAdapter;
import com.basketball.play.adapter.base.ViewHolder;
import com.basketball.play.bean.GroupMsg;
import com.basketball.play.ui.FaceTextUtils;
import com.basketball.play.ui.ImageBrowserActivity;
import com.basketball.play.ui.ImageLoadOptions;
import com.basketball.play.ui.LocationActivity;
import com.basketball.play.ui.SetMyInfoActivity;
...
/** 聊天适配器
  ...
  */
public class MessageChatAdapter extends BaseListAdapter<GroupMsg> {
	...
	public MessageChatAdapter(Context context,List<GroupMsg> msgList) {
	...
	public int getItemViewType(int position) {
		GroupMsg msg = list.get(position);
	...
	private View createViewByType(GroupMsg message, int position) {
	...
	public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		final GroupMsg item = list.get(position);
		if (convertView == null) {
...
//			}
	...
	/** 获取图片的地址--
	  ...
	  * @throws
	  */
	private String getImageUrl(GroupMsg item){
		String showUrl = "";
	...
	/** 处理图片
	  ...
	  * @throws
	  */
	private void dealWithImage(int position,final ProgressBar progress_load,ImageView iv_fail_resend,TextView tv_send_status,ImageView iv_picture,GroupMsg item){
		String text = item.getContent();
