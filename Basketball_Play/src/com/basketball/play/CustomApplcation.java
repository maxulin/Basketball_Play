...
import com.basketball.play.bean.GeoPointAndAdress;
import com.basketball.play.util.SharePreferenceUtil;
...
public class CustomApplcation extends Application {
	...
	public static GeoPointAndAdress address = new GeoPointAndAdress();
	@Override
...
//					BmobLog.i("两次获取坐标相同");// 若两次请求获取到的地理位置坐标是相同的，则不再定位
			...
			//String loc_address = location.getAddrStr();
			String loc_address = location.getCity()+location.getDistrict()+location.getStreet();
			address.setAddress(loc_address);
			//Toast.makeText(getApplicationContext(), "坐标:"+longtitude+","+latitude+"  位置："+loc_address, 3000).show();
		}
	}
