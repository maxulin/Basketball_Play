...
import com.basketball.play.util.CollectionUtils;
import com.basketball.play.util.PhotoUtil;
...
//				btn_chat.setOnClickListener(this);
	...
	private void initMeData() {
		UserBean user = userManager.getCurrentUser(UserBean.class);
		initOtherData(user.getUsername());
	}

	private void initOtherData(String name) {
		userManager.queryUser(name, new FindListener<UserBean>() {
	...
	private void updateInfo(int which) {
		final UserBean user = userManager.getCurrentUser(UserBean.class);
		...
		user.update(this, new UpdateListener() {
			...
			public void onSuccess() {
				// TODO Auto-generated method stub
				ShowToast("修改成功");
				final UserBean u = userManager.getCurrentUser(UserBean.class);
	...
	private void uploadAvatar() {
		BmobLog.i("头像地址：" + path);
		BTPFileResponse response = BmobProFile.getInstance(SetMyInfoActivity.this).upload(path, new UploadListener() {

			@Override
			public void onSuccess(String fileName,String url,BmobFile file) {
				// TODO Auto-generated method stub
				Log.i("smile", "新版文件服务的fileName = "+fileName+",新版文件服务的url ="+url);
				String upload_site_img =BmobProFile.getInstance(getApplicationContext()).signURL(fileName,url,"ffa7150668e1dc6b25eae12607d1cecb",0,null);
				updateUserAvatar(upload_site_img);
				if(file!=null){
